...
import static club.crabglory.www.common.widget.airpanel.Util.getDefaultPanelHeight;
import static club.crabglory.www.common.widget.airpanel.Util.updateLocalPanelHeight;
...
final class Helper implements Contract.Helper {
    ...
    private static class Boss implements Contract.Helper {
        ...
        private boolean isOpenSoftKeyboard() {
            return mLastFrame.bottom != 0
                    && mLastFrame.bottom <= mDisplayHeight*99/100
                    && mLastFrame.height() <= mDisplayHeight*99/100;
        }
    ...
    private static class Sub implements Contract.Helper {
        ...
        private Sub(View view, AirAttribute attribute) {
            ...
            mPanelHeight = getDefaultPanelHeight(mView.getContext(), mAttribute);
        }
        ...
        public void adjustPanelHeight(final int requestHeight) {
            ...
            if (height != mPanelHeight) {
                mPanelHeight = height;
                updateLocalPanelHeight(mView.getContext(), height);
            }
