...
public class Constants {
    ...
    public static String getBaseFolder() {
        ...
        if (!f.exists()) {
            boolean b = f.mkdirs();
            if (!b) {
                baseFolder = Application.Companion.getInstance()
    ...
    public static String getVideoPath() {
        ...
        return Constants.getPath("record/", time + ".mp4");
    }

    public static File[] getMicroVideoList() {
        File dir = new File(getBaseFolder() + "record/");
