package club.crabglory.www.common.widget.micro.record;
...
public class MediaRecorder {
    ...
    private boolean idRecord = false;
        ...
        while (true) {
            ...
            if (status == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (bufferInfo.size != 0) {
                    ...
                    if (bufferInfo.presentationTimeUs < lastTimsUs) {
                        // 增加 1微妙 / 20帧率 / 速率
                        bufferInfo.presentationTimeUs = (long) (lastTimsUs + 1_000_000 / 20 / mSpeed);
                    }
                    Log.e("Record", "时间搓：" + bufferInfo.presentationTimeUs + " last:" + lastTimsUs);
                    lastTimsUs = bufferInfo.presentationTimeUs;
