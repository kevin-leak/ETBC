...
//        return ioProvider.registerOutput(channel, outputCallback);
    ...
    /**
     * 实际IOProvider中线程池消费的线程
     * 将数据写入到Packet，也就是从Channel中读取数据
     */
    ...
    /**
     * 将数据写入到Channel，将Packet的数据输出到Channel
     */
