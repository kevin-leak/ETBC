...
public class ViewPageHelper<V extends View, F extends Fragment> {
     ...
     * 切换时候显示的边框，默认上边框
     */
    private int topBorder = R.drawable.bottom_border;
    /**
     * 处于negative状态的背景颜色
     */
    private int negativeColor = R.color.secondWindowBackgroundColor;
    /**
     * 当前的一个V,暴露给外界
     */
    private F current;
    ...
    public interface ViewPagerCallback<F extends Fragment>{

        void onChangedFragment(F currentFragment);
